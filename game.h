...
// The manager can create an entity objcet and add it to the vector
...
// The manager can also locate all objects with a given entity type
...
public:
	...
	// Apply a functon to all entieis of a given type
	...
	// Function to make all the netiteis draw themselves
...
class game
{
	...
	sf::RenderWindow game_window{ {constants::window_width, constants::window_height}, "Simple Breakout Game"s };
